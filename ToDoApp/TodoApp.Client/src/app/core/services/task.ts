...
import {Task, TaskListResponse, CreateTaskRequest, UpdateTaskRequest} from '../models/task.model';
...
export class TaskService 
{
  ...
  getTasks(search?: string, categoryId?: number, pageNumber: number = 1, pageSize: number = 10)
